...
////异步接收地址，仅支持http/https，公网可访问
        request.setNotifyUrl(" http://b9iq2p.natappfree.cc/orders/paynotify");
////同步跳转地址，仅支持http/https
//        request.setReturnUrl("http://domain.com/CallBack/return_url.jsp");
/******必传参数******/
        JSONObject bizContent = new JSONObject();
//商户订单号，商家自定义，保持唯一性
        bizContent.put("out_trade_no", "20240818010101020");
//支付金额，最小值0.01元
...
//请务必判断请求时的 total_fee、seller_id 与通知时获取的total_fee、seller_id 为一致的
//如果有做过处理，不执行商户的业务程序
//注意：
